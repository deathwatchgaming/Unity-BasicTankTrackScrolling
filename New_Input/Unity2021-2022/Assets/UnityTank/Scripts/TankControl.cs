...
namespace UnityTank.Scripts
{
	public class TankControl : MonoBehaviour
	{
		...
		public struct LeftWheel
		{
			...
			// The motorized boolean indicates whether this wheel should receive motor torque to propel the tank. Setting this to true allows the wheel to contribute to the tank's movement, while setting this to false means the wheel will only roll freely without providing any driving force.
        ...
        private void DoMovement()
        {
			...
			forwardSpeed = Vector3.Dot(transform.forward, rigidBody.velocity); // Speed in the forward direction
